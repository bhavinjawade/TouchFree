...
chrome.browserAction.onClicked.addListener(function() {
    ...
    chrome.tabs.getSelected(null, function(tab){
        ...
        if (running[tab.id] == undefined && started[tab.id] == undefined){
            chrome.tabs.executeScript(tab.id, {file: "scroll.js"}, function(e){
                chrome.tabs.executeScript(tab.id, {file: "main.js"}, function(e){
                    chrome.tabs.executeScript(tab.id, {code: "init();"}, function(response) {
            ...
            chrome.tabs.executeScript(tab.id, {code: "stop();"}, function(response) {
